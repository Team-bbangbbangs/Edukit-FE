...
export default function ExcelUploadModal({
  ...
  const handleSubmit = () => {
    ...
    createRecords(
      { recordType, studentRecords, semester: '2025-1' },
      {
  ...
  return (
    <Modal open={open} onOpenChange={handleClose}>
      <Modal.Overlay />
      <Modal.Content aria-describedby={undefined} className="max-w-[688px] rounded-xl p-5">
        <Modal.Close />
        <Modal.Title className="text-title-20">
        ...
        {uploadedStudents.length > 0 ? (
          <div className="w-full rounded-lg bg-gray-50 p-4">
            <h3 className="mb-2 font-semibold">업로드된 학생 목록 ({uploadedStudents.length}명)</h3>
